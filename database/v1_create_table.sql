...
INSERT INTO SPECIFICATION (ID, CATEGORY_ID, SPECIFICATIONS, CREATE_USER, CREATE_DATE, UPDATE_USER, UPDATE_DATE, DEL_FLAG) VALUES (SYS_GUID(), '35BC8EA0B9884374AEAC35F6194877A8', '[{"group":"主体","params":[{"k":"品牌"},{"k":"型号"}]}, {"group":"基本信息", "params":[{"k":"机身颜色"}]}]', 'crc', SYSDATE, NULL, NULL, '0');
